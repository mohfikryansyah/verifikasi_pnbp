            ...
            <div class="p-6 space-y-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="l1" id="l1"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" required value="{{ old('l1', $history->l1) }}">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="l2" id="l2"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" required value="{{ old('l2', $history->l2) }}">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="text" name="l3" id="l3"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" required value="{{ old('l3', $history->l3) }}">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input type="number" name="tahun" id="tahun"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" required value="{{ old('tahun', $history->tahun) }}">
                </div>
