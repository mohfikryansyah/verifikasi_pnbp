    ...
    <form method="POST" action="/home" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="masa_berlaku" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Masa
                        Berlaku
                        (Tahun)</label>
                ...
                <div class="col-span-6 sm:col-span-3">
                    <label for="bukti_bayar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bukti
                        Bayar</label>
