...
@section('content')
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <div class="flex flex-col -space-y-2">
                    ...
                    <span
                        class="md:text-2xl text-xl font-bold font-figtree whitespace-nowrap text-slate-800">GORONTALO</span>
                </div>
            </a>
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                @auth

                    <button id="dropdownHoverButton" data-dropdown-toggle="dropdownHover" data-dropdown-trigger="hover" data-dropdown-delay="50"
                        class="text-white bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"
                ...
                @else
                    <a href="{{ route('login') }}"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Login</a>
    ...
    <section
        class="sm:pt-[20vh] pt-[15vh] h-[100vh] bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')]'https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
            ...
            <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">
                VERIFIKASI PNBP</h1>
            <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48">Website ini menyediakan informasi
                terkait prosedur dan persyaratan izin pinjam pakai kawasan hutan untuk pengembangan berkelanjutan dan legal.
            </p>
            <form action="/" class="w-full max-w-md mx-auto">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 rtl:inset-x-0 start-0 flex items-center ps-3.5 pointer-events-none">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-500" aria-hidden="true"
                            fill="currentColor"
                    ...
                    <input type="search" id="keyword" name="keyword"
                        class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-green-500 focus:border-green-500"
                    ...
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-white" aria-hidden="true"
                            fill="currentColor"
        ...
        <div class="bg-gradient-to-b from-green-50 to-transparent w-full h-full absolute top-0 left-0 z-0">
        </div>
    </section>

    <section class="bg-gray-50">
        <div class="max-w-screen-xl py-8 px-4 mx-auto">
            <div class="w-full lg:-mt-40 -mt-[100px]">
                <div class="relative overflow-x-auto shadow-md rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                        <thead class="text-xs text-gray-100 uppercase bg-green-400">
                            <tr>
            ...
            <div class="relative bg-white rounded-lg shadow">
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                <tr class="bg-white border-b">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="https://wa.me/6281234567890" class="text-blue-400 hover:text-blue-500"
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="defaultModal" type="button"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="bg-whitemax-w-screen-xl p-4 py-6 mx-auto lg:py-12 md:p-8 lg:p-10">
        ...
        <div class="text-center">
            ...
            <span class="block text-sm text-center text-gray-500">© 2023 Mahasiswa Magang
